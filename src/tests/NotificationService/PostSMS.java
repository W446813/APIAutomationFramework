...
public class PostSMS {
    ...
    public void allRequiredInfo() throws Exception {
        ...
        response = RestAssured.given()
                ...
                .body("{\"phoneNumberTo\":\"3852386092\"," +
                        "\"messageBody\":\"Testing notification service\"}")
...
//                        "\"messageBody\":\"Testing notification service\"}")
    ...
    public void withWrongBodyParams() throws Exception {
        ...
        response = RestAssured.given()
                ...
                .header("Content-Type","application/json")
                .header("Cache-Control","no-cache")
                .body("{\"WrongphoneNumberTo\":\"3852386092\"," +
                        "\"WrongmessageBody\":\"Testing notification service\"}")
                .relaxedHTTPSValidation().when()
                .post(url);
        compare.compare(response,expectedResponseCode);
    }
    ...
    public void withWrongBodyValues() throws Exception {
        ...
        response = RestAssured.given()
                ...
                .header("Content-Type","application/json")
                .header("Cache-Control","no-cache")
                .body("{\"phoneNumberTo\":\"phoneNumber\"," +
                        "\"messageBody\":\"Testing notification service\"}")
                .relaxedHTTPSValidation().when()
                .post(url);
        compare.compare(response,expectedResponseCode);
