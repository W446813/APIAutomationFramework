...
public class PostPushRegister {
    ...
    public PostPushRegister() throws IOException {
    }

    @Test(priority = 0, groups = "ReadyForCICD")
    public void getOAuthToken() throws Exception {
        logs.setupTestClass("POST - /push/register");
    ...
    public void allRequiredInfo() throws Exception {
        ...
        response = RestAssured.given()
                ...
                .body("{\n" +
                        "  \"applicationName\": \"driver-dash\",\n" +
                        "  \"deviceIdentification\": \"aaaaaaaaaa\",\n" +
                        "  \"appIdentityExternalId\": \"fsdfsgsdfsdfs\",\n" +
    ...
    public void withoutCacheControlTypeHeader() throws Exception {
        expectedResponseCode = 200;
...
//                        "}")
    ...
    public void withWrongBodyParams() throws Exception {
        ...
        response = RestAssured.given()
                ...
                .header("Cache-Control","no-cache")
                .body("{\n" +
                        "  \"WrongapplicationName\": \"driver-dash\",\n" +
                        "  \"WrongdeviceIdentification\": \"aaaaaaaaaa\",\n" +
                        "  \"WrongappIdentityExternalId\": \"fsdfsgsdfsdfs\",\n" +
                        "  \"WrongoperatingSystem\": \"ANDROID\"\n" +
                        "}")
                .relaxedHTTPSValidation().when()
                .post(url);
        compare.compare(response,expectedResponseCode);
